...
import secImg from '../assets/images/2nd-sec-img.png'
                ...
                <div className="container pb-md-5">
                    <div className="row pt-4 pb-5">
                        <div data-aos="fade-right" className="col-lg-6 col-12 ">
                            <img src={secImg} alt="elephant-wearing-cap" className="w-100 " />
                        </div>
                        <div data-aos="fade-left" className="col-lg-6 col-12 d-flex flex-column justify-content-center pl-lg-243">
                            <h2 className="text-white fs-xxl fw-semibold ff-poppins  pt-2">Mint Your Bat</h2>
                            <p className="lh-136 fs-xl1 fw-medium text-white ff-poppins">Minting: 1,5 SOL</p>
                            <p className=" text-decoration-line-through text_gray3 fw-normal ff-poppins lh-136 fs-md">Before 2 SOL</p>
                            <h3 className="lh-136 fs-xl1 fw-medium text-white ff-poppins">Whitelist: 0,88 SOL</h3>
                            <p className="text-decoration-line-through text_gray3 fw-normal ff-poppins lh-136 fs-md">Before 1 SOL</p>
                            <button className="secondary-btn mb-5 fs-md fw-medium text_light-blue1">Comming Soon</button>
                            <div className="d-flex gap-4">
                                <a href="https://www.instagram.com/accounts/login/" target='_blank' className="z-3"><svg width="33" height="33"
                                ...
                                <a href="https://twitter.com/i/flow/login" target='_blank'><svg width="36" height="29" viewBox="0 0 36 29"
                                ...
                                <a href="https://discord.com/" target='_blank'><svg width="33" height="25" viewBox="0 0 33 25" fill="none"
